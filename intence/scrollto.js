/**
 * @fileoverview scrollto - smoothly scrolls to the desired position
 * @version 0.0.1
 * 
 * @license MIT, see http://github.com/asvd/scrollto
...
function (exports) {
    ...
    /**
     * Calculation of the animation frames spline
     * 
     ...
     */
    function scrollTopTo(elem, pos, time) {
        time = time || TIME;
     ...
     * @param {Number} time (msec) of animation
     */
    function scrollLeftTo(elem, pos, time) {
        time = time || TIME;
        elem = elem.scroller || elem;
    ...
    exports.top = scrollTopTo;
    exports.left = scrollLeftTo;
}));
